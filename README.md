...
Questions on data
1. Why was INNER JOIN the correct and sufficient choice for this specific task? This will enable joining of the tables and common columns only will be retrieved to be able to get the top 5 products by category 
What data would be excluded by using it? Data that is not common in the orders, order_items and products table
